...
INSERT INTO `cotacoes` (`cod`, `pedido`, `empresa`, `observacao`, `last_update`) VALUES
	(1, 1, '24846428000118', 'TESTE', '2021-11-22 23:51:23');
...
-- Copiando dados para a tabela database_portal.cotacoes_itens: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela database_portal.documento_empresa_privada: ~13 rows (aproximadamente)
...
INSERT INTO `endereco_instituicao_publica` (`cod`, `logradouro`, `numero`, `bairro`, `cep`, `cidade`, `uf`, `cnpj`, `descricao`) VALUES
	(1, 'R DOM DUARTE LEOPOLDO', '83', 'CENTRO', '12955000', 'BOM JESUS DOS PERDOES', 'SP', '52359692000162', NULL),
	...
	(22, 'AL TIBIRICA', '374', 'CENTRO', '07600000', 'MAIRIPORA', 'SP', '46523163000150', NULL);
...
INSERT INTO `instituicao_publica` (`cnpj`, `razao_social`, `nome_fantasia`, `efr`, `email`, `natureza`, `telefone`, `status_cadastro`) VALUES
	...
	('45279643000154', 'z\\xz', 'NAZARE PAULISTA GABINETE PREFEITO', 'NAZARE PAULISTA - SP', 'nazare@nazare.sp.gov.br', '124-4 - Município', '11 97875756', 3),
	...
	('46523163000150', 'MUNICIPIO DE MAIRIPORA', 'MAIRIPORA GABINETE DO PREFEITO', 'MUNICÍPIO DE MAIRIPORA', 'cpd@mairipora.sp.gov.br', '124-4 - Município', '11 4589 98754', 1),
	...
	('52359692000162', 'MUNICIPIO DE BOM JESUS DOS PERDOES', 'BOM JESUS DOS PERDOES GABINETE PREFEITO', 'MUNICÍPIO DE BOM JESUS DOS PERDOES', 'cpd@bjperdoes.sp.gov.br', '124-4 - Município', '(19) 3441-8946', 3),
...
INSERT INTO `login_instituicao_publica` (`login`, `cnpj`, `senha`) VALUES
	...
	('cpd@mairipora.sp.gov.br', '46523163000150', '123'),
...
INSERT INTO `status_cadastro_hist` (`cod`, `cnpj`, `status`, `data`) VALUES
	...
	(23, '46523163000150', 1, '2021-11-22 19:09:45');
