        ...
        <div class="container col-lg-6" id="container-corpoindex">
            <div class="img centro">
                ...
                <form action="inserirEnderecoAction.php" method="post"> 
                    ...
                    <p><input placeholder="CEP" class='form-control-input' name="txtCEP" required></p><br>
                    <p><input placeholder="Cidade" class='form-control-input' name="txtCidade" required></p><br>
                    <p><input placeholder="UF" class='form-control-input' name="txtUF" required></p><br>
                    <p><textarea class='form-control-textarea' placeholder="Descrição do endereço" name="txtDescricao" required></textarea></p><br>
                    <p><input type='submit' value="Prosseguir" id="btnSubmit" class="btn btn-md buttoncad"/></p>
                </form> 
