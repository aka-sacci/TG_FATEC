...
if (isset($_SESSION['login'])) {
    if ($_SESSION['type'] == "PRI") {
        ...
        $_SESSION['erroReportado'] = "Não é possível logar numa conta privada estando logado em uma conta de empresa pública!!";
...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>Login Empresa Privada</title>
        ...
        <div class="text-center loginphp">
            <main class="form-signin">
                <form action="../config/loginAction.php" method="post"> 
                    ...
                    <h4 class="mb-3 fw-normal">Login - Instituição Privada</h4>
