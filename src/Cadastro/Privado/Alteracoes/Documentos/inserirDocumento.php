        ...
        <div class="container col-lg-6" id="container-corpoindex">
            ...
            <h3><B>ADICIONAR NOVO DOCUMENTO</B></h3><hr><br>
                ...
                <form action="inserirDocumentoAction.php" method="post" enctype="multipart/form-data"> 
                    ...
                    <p><b>Arquivo:</b>
                    <br><input class="form-control-input anexo" type="file" name="file" accept=".pdf" required></p>
                    
                    <p><b>Descrição:</b>
                    <br><input placeholder="Descrição" class="form-control-input" type="text" name="txtDesc" required></p>
                    <br><p><input type='submit' value="Inserir Documento" id="btnSubmit" class="btn btn-md buttoncad"/></p>
                </form>
