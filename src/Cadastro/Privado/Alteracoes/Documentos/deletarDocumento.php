...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container col-lg-6" id="container-corpoindex">
            ...
            <br> 
            <h3><B>EXCLUSÃO DE DOCUMENTO</B></h3><hr>
                <form action="deletarDocumentoAction.php" method="post"> 
                    ...
                    <p><b>Para confirmar a exclusão do documento acima, digite sua senha.</b></p><input class="form-control-input" name="txtSenha" type="password" required>
                    <br><p><input type='submit' value="Confirmar" id="btnSubmit" class="btn btn-md buttoncad"/></p>
                </form> 
            <br><br><br><br><br>
