    ...
    <body>
        <div class="container py-4" id="container-corpoindex">
            <div class="alert alert-success" role="alert">
                ...
                <h4 class="alert-heading">Seu cadastro foi concluído!</h4>
                <p>Faça já o seu login e Aproveite nossa Plataforma.</p>
            </div>
            <p><a href="../../../index.php" class="btn btn-md btn-primary">Voltar ao início</a></p>
        </div>
        <!-- footer da página -->
