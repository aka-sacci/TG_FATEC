...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container col-lg-6" id="container-corpoindex">
            ...
            <br> 
            <h3><B>ADICIONAR NOVO ANEXO</B></h3><hr><br>
                ...
                <form action="adicionarAnexoAction.php" method="post" enctype="multipart/form-data"> 
                    ...
                    <p>
                    <input placeholder="Descrição do documento" class="form-control-input" type="text" name="txtDesc" required>
                    </p>
                    <p>
                    <input class="form-control-input anexo" type="file" name="file" accept=".pdf" required></p><br>
                    <p><input type='submit' value="Inserir Anexo" id="btnSubmit" class="btn btn-md buttoncad"/></p>
                </form> 
