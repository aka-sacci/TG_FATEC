        ...
        <div class="container col-lg-6" id="container-corpoindex">
            ...
            <h3><B>EXCLUSÃO DE DOCUMENTO</B></h3><hr>
                <form action="deletarAnexoAction.php" method="post"> 
                    ...
                    <p><b>Para confirmar a exclusão do anexo acima, digite sua senha.</b></p><input class="form-control-input" name="txtSenha" type="password" required>
                    <p><input type='submit' value="Confirmar" id="btnSubmit" class="btn btn-md buttoncad"/></p>
                </form> 
            <br><br><br><br><br>
