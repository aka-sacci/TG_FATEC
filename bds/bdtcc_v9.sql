...
INSERT INTO `anexos_cotacoes` (`cod`, `cotacao`, `descricao`) VALUES
	(6, 39, 'CATÁLOGO DA PLACA DE VIDEO');
...
-- Copiando dados para a tabela database_portal.categoria_pedido: ~3 rows (aproximadamente)
...
INSERT INTO `cotacoes` (`cod`, `pedido`, `empresa`, `observacao`, `last_update`) VALUES
	(39, 18, '24846428000118', '', '2021-11-21 15:52:33');
...
-- Copiando dados para a tabela database_portal.cotacoes_itens: ~5 rows (aproximadamente)
...
INSERT INTO `cotacoes_itens` (`cod`, `valor_un`, `item_ref`, `descricao_modelo`, `cotacao`) VALUES
	(74, '2599.50', 23, 'Placa de Vídeo Asus NVIDIA GeForce GTX 1650, 4GB, GDDR6 - TUF-GTX1650-O4GD6-P-GAMING ', 39),
	(75, '265.50', 16, 'Memória RAM Crucial Ballistix 8GB DDR4 2666 Mhz, CL16, UDIMM, Preto - BL8G26C16U4B', 39),
	(76, '359.90', 26, 'HD Externo Seagate Portátil Expansion 1TB, USB 3.0, Preto - STEA1000400', 39),
	(77, '399.90', 24, 'SSD WD Blue, 250GB, SATA, Leitura 550MB/s, Gravação 525MB/s - WDS250G2B0A', 39),
	(78, '69.90', 25, 'Pen Drive DataTraveler Exodia 32GB Kingston com Conexão USB 3.2, Preto/Branco - DTX/32GB', 39);
...
-- Copiando dados para a tabela database_portal.documento_empresa_privada: ~2 rows (aproximadamente)
...
INSERT INTO `endereco_empresa_privada` (`cod`, `logradouro`, `numero`, `bairro`, `cep`, `cidade`, `uf`, `cnpj`, `descricao`) VALUES
	...
	(16, 'Av. São João', '1305', 'CENTRO', '12940260', 'ATIBAIA', 'SP', '24846428000118', 'FILIAL DE ATIBAIA');
...
-- Copiando dados para a tabela database_portal.endereco_instituicao_publica: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela database_portal.item_pedido: ~18 rows (aproximadamente)
...
-- Copiando dados para a tabela database_portal.status_cadastro_hist: ~8 rows (aproximadamente)
