...
-- Copiando dados para a tabela database_portal.categoria_pedido: ~5 rows (aproximadamente)
...
INSERT INTO `item_pedido` (`cod`, `item`, `descricao`, `quantidade`, `unidade`, `pedido_cod`) VALUES
	...
	(27, 'ITEM TESTE 2', 'DESCRIÇÃO DO ITEM TESTE 2', 100, 'un', 19),
	(28, 'ITEM TESTE 1', 'DESCRIÇÃO DO ITEM TESTE 1', 50, 'un', 19);
...
INSERT INTO `pedido` (`cod`, `titulo`, `descricao`, `data_abertura`, `data_fechamento`, `status`, `modo`, `cnpj`, `distancia`) VALUES
	...
	(19, 'TESTE 1 ', 'DESCRIÇÃO DO TESTE 1', '2021-11-17 01:32:42', NULL, 1, 1, '52359692000162', 0);
