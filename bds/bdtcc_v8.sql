...
-- Copiando dados para a tabela database_portal.anexos_pedido: ~1 rows (aproximadamente)
...
INSERT INTO `cotacoes` (`cod`, `pedido`, `empresa`, `observacao`, `last_update`) VALUES
	(25, 18, '10176707000107', 'preço sugerido no catálogo é impraticável ', '2021-11-19 13:50:49');
...
INSERT INTO `cotacoes_itens` (`cod`, `valor_un`, `item_ref`, `descricao_modelo`, `cotacao`) VALUES
	(18, '4500', 23, 'ASUS GTX 1650TI TUF GAMING', 25),
	(19, '300', 16, 'MEMÓRIA KINGSTON 2666MHz', 25);
...
INSERT INTO `item_pedido` (`cod`, `item`, `descricao`, `quantidade`, `unidade`, `pedido_cod`) VALUES
	...
	(32, 'ITEM 2 TESTE', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa', 1, 'un', 23),
	(33, 'ITEM 1 TESTE', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa', 5, 'un', 23);
...
-- Copiando dados para a tabela database_portal.notificacao_pedido: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `notificacao_pedido` DISABLE KEYS */;
INSERT INTO `notificacao_pedido` (`cod`, `pedido`, `empresa`, `status`) VALUES
	(15, 23, '08914106000102', 1),
	(16, 23, '10176707000107', 2);
...
-- Copiando dados para a tabela database_portal.pedido: ~2 rows (aproximadamente)
...
INSERT INTO `pedido` (`cod`, `titulo`, `descricao`, `data_abertura`, `data_fechamento`, `distancia`, `status`, `modo`, `cnpj`, `endereco_entrega`) VALUES
	...
	(23, 'PEDIDO TESTE DE ATIBAIA', 'ESTE PEDIDO É USADO COMO TESTE', '2021-11-19 09:33:24', '2021-11-19 09:35:21', 30, 1, 2, '45279635000108', 2);
