...
-- Copiando dados para a tabela database_portal.categoria_pedido: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela database_portal.item_pedido: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `item_pedido` DISABLE KEYS */;
INSERT INTO `item_pedido` (`cod`, `item`, `descricao`, `quantidade`, `unidade`, `pedido_cod`) VALUES
	(1, 'IMPRESSORA COLORIDA', 'IMPRESSORA COLORIDA VÁRIAS CARACTERÍSTICAS', 20, 'un', 15),
	(2, 'IMPRESSORA MONOCROMÁTICA', 'IMPRESSORA MONOCROMÁTICA COM VÁRIAS CARACTERÍSTICAS', 50, 'un', 15),
	(3, 'AAAAAAAA', 'AAAAAAAAAA', 1, 'un', 16),
...
INSERT INTO `login_instituicao_publica` (`login`, `cnpj`, `senha`) VALUES
	('cpd@bjperdoes.sp.gov.br', '52359692000162', '1234'),
...
-- Copiando dados para a tabela database_portal.notificacao_pedido: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `notificacao_pedido` DISABLE KEYS */;
INSERT INTO `notificacao_pedido` (`cod`, `pedido`, `empresa`, `status`) VALUES
	(1, 15, '10176707000107', 1),
	(2, 16, '04911191000102', 1),
	(3, 16, '08914106000102', 1),
	(4, 16, '10176707000107', 1),
	(10, 18, '04911191000102', 1),
	(11, 18, '08914106000102', 1),
	(12, 18, '10176707000107', 1);
...
-- Copiando dados para a tabela database_portal.pedido: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
INSERT INTO `pedido` (`cod`, `titulo`, `descricao`, `data_abertura`, `data_fechamento`, `status`, `modo`, `cnpj`, `distancia`) VALUES
	(15, 'Licitação de impressoras', 'Licitação para aluguel de impressoras', '2021-11-11 21:48:45', NULL, 1, 2, '52359692000162', 50),
	(16, 'Licitação de impressoras 2', 'AAAAAAAAAAAAA', '2021-11-11 21:50:29', NULL, 1, 2, '52359692000162', 0),
	(18, 'AQUISIÇÃO DE EQUIPAMENTOS ESSENCIAIS INFORMÁTICA', 'Aquisição de Equipamentos Essenciais Trabalhos CPD de informáticas para \r\nvários setores e secretarias na prefeitura de Bom Jesus dos Perdões pelo Sistema \r\nRegistro de Preços:', '2021-11-14 23:42:44', NULL, 1, 2, '52359692000162', 100);
