...
-- Copiando dados para a tabela database_portal.item_pedido: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela database_portal.notificacao_pedido: ~4 rows (aproximadamente)
